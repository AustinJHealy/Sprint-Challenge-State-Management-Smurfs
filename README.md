...
Context API is similar to Redux and the purpose of these types of libraries is to solve the problem of prop drilling and managing state in large scale applications.

- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

Actions are the functions that perform specific processes that change state data in the store by way of the reducer.
...
I prefer Redux at the moment simply because I have learned more about it and I have more experience with it at this time but that will probably change soon.
